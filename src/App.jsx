        ...
        <nav className="bg-blue-800 text-white shadow-md px-5 py-2 relative sticky top-0 z-50">
          <div className="max-w-8xl mx-auto flex items-center justify-between">
            ...
            >
              ...
              <span className="font-bold text-l hidden sm:inline">
                Electricista +
              </span>
            </Link>
            ...
            <ul className="hidden sm:flex justify-center items-center gap-[2px]">
              <li>
                <Link
                  to="/calculadora"
                  className="block w-32 text-center py-2 rounded hover:bg-blue-700 transition"
                >
                  Calculadora
                </Link>
              </li>
              ...
              {/* 🧩 NUEVO: botón que abre el Asistente en modo sugerencia */}
              <li>
                <button
                  onClick={() => window.openAsistente("sugerencia", "navbar")}
                  className="block w-32 text-center py-2 rounded hover:bg-blue-700 transition"
                >
                  Comentarios
                </button>
